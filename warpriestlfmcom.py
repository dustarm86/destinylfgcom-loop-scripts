...
select_activity = browser.find_element_by_xpath(".//*[@id='selectActivity']/optgroup[9]/option[3]").click()

# write description for activity chosen
description = browser.find_element_by_xpath(".//*[@id='textComment']")
description.send_keys("WARPRIEST: Need 3 +305's with experience and good weapons. Message and Friend Request me on PSN to Join! PSN = Conscious_Acts ")
